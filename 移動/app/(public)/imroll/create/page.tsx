            ...
            <form action={formAction} className="space-y-6">
                ...
                <div>
                    ...
                    <select
                        id="grinding_type"
                        name="grinding_type"
                        className="border p-2 text-xl flex-1 rounded w-full h-[48px]"
                    >
                ...
                <div>
                    ...
                    <Input type="date" id="operation_date" name="operation_date" className="border border-gray-300 rounded px-3 py-2 text-lg w-full h-[48px]" />
                </div>
