...
export async function createImroll(
    ...
    const grinding_amount = Number((imr_diameter_before - imr_diameter_after).toFixed(2)); // 研削量は加工前径 - 加工後径で計算
