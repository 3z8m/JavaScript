            ...
            <form action={formAction} className="space-y-4 text-center">
                ...
                <div className="flex flex-row items-center justify-center font-bold text-4xl">
                    <div className="flex flex-col items-center px-4">
                        <input type="radio" name="presence" value="#4169E1" checked={presence === "#4169E1"} 
                    ...
                    <div className="flex flex-col items-center px-4">
                        <input type="radio" name="presence" value="#800080" checked={presence === "#800080"} 
                        onChange={(e) => setPresence(e.target.value)} style={presenceRadioStyle} />
                ...
                {/* ----------------------------------------------------------------
                        行先 
                    ----------------------------------------------------------------*/}
                <div className="flex flex-row items-center justify-center font-bold text-2xl">  
